        ...
        columnHelper.accessor("action", {
            ...
            cell: (info: any) => (
                <span className='flex gap-2'>
                    ...
                    <FilePenLine className='text-gray-500 hover:text-gray-200 cursor-pointer min-w-6 min-h-6 '
                        onClick={() => {
                    ...
                    />
                    <Separator orientation='vertical' className='h-5' />
                    <Trash className='text-red-300 hover:text-red-700 cursor-pointer min-w-6 min-h-6'
                        onClick={() => {
